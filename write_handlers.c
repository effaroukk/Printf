...
/*HANDLING WRITE*/
/**
 * handle_write_char -  one char string print
 * @c: char types.
...
/**
 * write_num - using a bufffert to write num
...
/**
 * write_pointer - Writing address on memory
 * @buffer: chars array
 * @width: Width specifier
 ...
 * @padd_start:starting padding index
 *
 * Return: Number of written chars.
 */
